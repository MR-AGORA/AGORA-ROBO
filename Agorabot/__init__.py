...
if ENV:
    ...
    START_IMG = os.environ.get("START_IMG", "https://te.legra.ph/file/74ee67eecdc592fc47d84.jpg")
    ASS_USERNAME = os.environ.get("ASS_USERNAME", "")
    BOT_TUT = os.environ.get("BOT_TUT", "https://te.legra.ph/file/10ae4c864163e608b756e.jpg")
    MUSICBOT_TUT = os.environ.get("MUSICBOT_TUT", "https://te.legra.ph/file/3969c0a47ce8894f057d6.jpg")
    PORT = int(os.environ.get("PORT", 5000))
    CERT_PATH = os.environ.get("CERT_PATH")
    API_ID = os.environ.get("API_ID", None)
    API_HASH = os.environ.get("API_HASH", None)
    DB_URI = os.environ.get("DATABASE_URL")
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "AGORA_ROBOTS")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "AGORA_ARMY")
    ...
    from Agorabot.config import Development as Config
...
from Agorabot.modules.helper_funcs.handlers import (
